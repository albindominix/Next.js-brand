...
export default function HeroBanner() {
  return (
    <div className='relative text-white text-[20px] w-ful max-w-[1360px] mx-auto'>
      <Carousel
       autoPlay={true}
       infiniteLoop={true}
       showThumbs={false}
       ...
       renderArrowNext={(clickHandler,hasPrev)=>(
        <div onClick={clickHandler}
        className='absolute right-0   w-[30px] bottom-0 md:w-[50px] h-[30px] md:h-[50px] bg-black z-10 flex items-center justify-center cursor-pointer hover:opacity-90'>
